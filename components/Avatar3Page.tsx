    ...
    <div className="flex flex-col gap-6">
      ...
      {!isContactStep ? (
        ...
        <form onSubmit={submitContact} className="flex flex-col gap-5">
          ...
          >
            {loading ? "Versturen..." : "Stuur mijn gratis groeiplan →"}
    ...
    <section id="quiz" className="py-24 px-6 bg-white">
      <div className="max-w-5xl mx-auto">
        <div className="grid md:grid-cols-2 gap-16 items-start">
          ...
          <div id="quiz-form" className="bg-gray-50 rounded-[32px] border border-gray-200 p-5 sm:p-8 shadow-sm overflow-hidden">
            <QuizFunnel />
          </div>
        </div>
      </div>
